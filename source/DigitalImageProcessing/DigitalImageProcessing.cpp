...
// DigitalImageProcessing.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CDigitalImageProcessingApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CDigitalImageProcessingApp::OnAppAbout)
...
// создание CDigitalImageProcessingApp
...
CDigitalImageProcessingApp::CDigitalImageProcessingApp()
{
	...
	SetAppID(_T("DigitalImageProcessing.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CDigitalImageProcessingApp

CDigitalImageProcessingApp theApp;


// инициализация CDigitalImageProcessingApp
...
BOOL CDigitalImageProcessingApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CDigitalImageProcessingDoc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(CDigitalImageProcessingView));
	if (!pDocTemplate)
		return FALSE;
...
int CDigitalImageProcessingApp::ExitInstance()
{
...
// обработчики сообщений CDigitalImageProcessingApp
...
void CDigitalImageProcessingApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
